...
public class fileApp {
    Icon fileIcon = new Icon("/home/pijus/Desktop/Programming_languages/Java/FileExplorerVersion1/file.png", 65, 65);// folder
                                                                                                                     // +
                                                                                                                     // directory
                                                                                                                     // icons
    Icon folderIcon = new Icon("/home/pijus/Desktop/Programming_languages/Java/FileExplorerVersion1/folder.png", 65,
            65);
    Panel filePanel;
    Panel topPanel;
    ...
    JFrame frame;
    JTree fileTree;
    int maxWidth = (folderIcon.getWidth() > fileIcon.getWidth() ? folderIcon.getWidth() : fileIcon.getWidth());// delete
                                                                                                               // later,
                                                                                                               // because
                                                                                                               // icon
                                                                                                               // size
    ...
    public void customLayout(List<JLabel> buttons) {
        ...
        for (int i = 0; i < buttons.size(); i++) {
            ...
            if (f1.isFile()) {
                buttons.get(i).setBounds(countx * x + initSpace, county * y + initSpace, fileIcon.getWidth() + 20,
                        fileIcon.getHeight() + 20);
            } else if (f1.isDirectory()) {
                buttons.get(i).setBounds(countx * x + initSpace, county * y + initSpace, folderIcon.getWidth() + 20,
                        folderIcon.getHeight() + 20);
            }
            countx++;
        }
