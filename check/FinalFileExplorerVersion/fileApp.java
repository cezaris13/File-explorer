...
public class fileApp {
    String saveLocation = "/home/pijus/Desktop/Programming_languages/Java/FinalFileExplorerVersion/directory.out";
    String saveFiles = "/home/pijus/Desktop/Programming_languages/Java/FinalFileExplorerVersion/files.out";
    String saveFolders = "/home/pijus/Desktop/Programming_languages/Java/FinalFileExplorerVersion/folders.out";
    ...
    public void customLayout(List<CustomJLabel> fileList, List<CustomJLabelFolders> folderList) {
        ...
        for (int i = 0; i < folderList.size(); i++) {
            ...
            folderList.get(i).setBounds(countx * x + initSpace, county * y + initSpace,
                    folderList.get(i).folderIcon.getWidth() + 20, folderList.get(i).folderIcon.getHeight() + 20);
            countx++;
        }
        for (int i = 0; i < fileList.size(); i++) {
            if (x * (countx + 1) > x * (space - 3)) {
