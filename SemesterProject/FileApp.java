...
public class FileApp {
    ...
    public void setupFileApp() {
        ...
        CustomPanel.directory =  System.getProperty("user.home") + System.getProperty("file.separator") + "Desktop";
    ...
    public void updateFiles(String directory) {
        ...
        for (int i = 0; i < list.length; i++) {
            File f1 = new File(directory + separator + list[i]);
            if (!f1.isFile())
                continue;
            ...
            addFileMouseListener(FileManagement.fileList.get(count), list[i]);
            count++;
        }
        count = 0;
        ...
        for (int i = 0; i < list.length; i++) {
            ...
            fileExplorerComponents.filePanel.panel.add(tmp);
            addFolderMouseListener(FileManagement.folderList.get(count), directory, list[tmpi]);
            count++;
        ...
        customJLabelFolder.addMouseListener(new MouseAdapter() {
                public void mouseClicked(MouseEvent e) {
                    if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2) {
                        ...
                        fileExplorerComponents.frame.setSize(width, height - 1); // TODO this?
